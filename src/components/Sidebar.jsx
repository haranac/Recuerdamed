  ...
  return (
    <aside className="hidden min-h-screen w-[270px] shrink-0 flex-col border-r border-slate-200 bg-white lg:flex">
      ...
      <nav className="flex-1 overflow-y-auto px-4 py-6">
        {modoDemo && (
          <div className="mb-6 rounded-[20px] border border-blue-100 bg-[#eaf6ff] p-4">
            <div className="flex items-center gap-2 text-[#087ef5]">
              <Eye size={18} />
            ...
            <p className="mt-2 text-xs leading-5 text-slate-500">
              Los datos son de ejemplo y no se guardará
        ...
        {!modoDemo && (
          <div className="mt-8 rounded-[22px] bg-[#eaf6ff] p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-slate-500">
              Registra tus próximas citas y recordatorios
              de medicamentos.
            </p>
          </div>
        )}
        ...
        <div className="mb-3 flex items-center gap-3 rounded-2xl bg-slate-50 p-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p
              className={
                modoDemo
                  ? "truncate text-xs font-semibold text-[#087ef5]"
